...
PokecomCenterOffice_MapScripts:
	db 0 ; scene scripts
...
PokecomCenterOffice_MapEvents:
	...
	bg_event  6,  4, BGEVENT_UP, PokecomCenterAdminOfficeMobileComputer1
	bg_event  6,  2, BGEVENT_UP, PokecomCenterAdminOfficeMobileComputer2
