...
ViridianCity_MapEvents:
	...
	db 5 ; warp events
	warp_event 32,  9, VIRIDIAN_GYM, 1
	warp_event 21, 11, VIRIDIAN_NICKNAME_SPEECH_HOUSE, 1
	warp_event 23, 19, TRAINER_HOUSE_1F, 1
	...
	bg_event 27,  9, BGEVENT_READ, ViridianGymSign
	bg_event 20,  2, BGEVENT_READ, ViridianCityWelcomeSign
	...
	object_event 31, 10, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ViridianCityGrampsNearGym, -1
